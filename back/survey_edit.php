...
<form action="./api/survey_edit.php" class="col-10 mx-auto d-flex flex-wrap justify-content-end" method="post">
    <div class="form-group row col-12">
        ...
        <input type="text" class="form-control col-10" name="subject" value="<?= $subject['subject']; ?>">
    ...
    ?>
        ...
        <div class="form-group row col-11">
            ...
            <input type="text" class="form-control col-10" name="opt[]" value="<?=$option['opt'];?>">
            <input type="text" class="form-control col-10" name="optid[<?= $option['id']; ?>]" value="<?=$option['opt'];?>">
